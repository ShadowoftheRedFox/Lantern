...
function GameCrashHandler(scope) {
    return function crashHandler() {
        ...
        if ($.offsetHeight != scope.h || $.offsetWidth != scope.w) {
            ...
            for (var entity in scope.state.entity) {
                if (scope.state.entity[entity].activated) {
                    scope.state.entity[entity].needsUpdate = true;
                    scope.state.entity[entity].resized = true;
                }
            }
        }
    };
